...
class Book(BaseModel):
    ...
    description: Optional[str] = Field(title="Description of the Book",
                                       max_length=100,
                                       min_length=1)
    rating: int = Field(gt=-1, ls=101)

    class Config:
        schema_extra = {
            "example": {
                "id": "16a90374-e391-48b1-aa62-4da9599c40d1",
...
async def book_login(book_id: int, username: Optional[str] = Header(None), password: Optional[str] = Header(None)):
    if username == "FastAPIUser" and password == "test1234!":
        if book_id < 0:
            raise NegativeNumberException(books_to_return=book_id)
...
def create_books_no_api():
    book_1 = Book(id="66a90374-e391-48b1-aa62-4da9599c40d1",
                  title="Title 1",
                  author="Author 1",
                  description="Description 1",
                  rating=60)
    book_2 = Book(id="56a90374-e391-48b1-aa62-4da9599c40d1",
                  title="Title 2",
                  author="Author 2",
                  description="Description 2",
                  rating=70)
    book_3 = Book(id="46a90374-e391-48b1-aa62-4da9599c40d1",
                  title="Title 3",
                  author="Author 3",
                  description="Description 3",
                  rating=80)
    book_4 = Book(id="36a90374-e391-48b1-aa62-4da9599c40d1",
                  title="Title 4",
                  author="Author 4",
